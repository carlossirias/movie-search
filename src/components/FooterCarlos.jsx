...
export function Footer({colorText, colorHover, isBlack = true})
{
    ...
    return(
        <footer className={`fixed z-10 pr-5 flex self-center bg-black/20 bottom-2 md:left-2 p-3 rounded-full overflow-hidden  backdrop-blur-xl`}>
            <div className="flex gap-4">
                <img src="https://github.com/carlossirias.png" className="w-12 rounded-full " alt="" />
                <div>
                    <h1 className="font-semibold text-white">Carlos Sirias</h1>
                    <a href={`https://github.com/carlossirias`} className={`text-rose-600 transition font-medium`}>@carlossirias</a>
                </div>
